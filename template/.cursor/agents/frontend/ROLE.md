...
Own **`{{FRONTEND_DIR}}/`** — UI, client routing/state, and API client consumption.

## Responsibilities

- Implement screens / components under `{{FRONTEND_DIR}}/`
...
- Project rules under `.cursor/rules/` that match `{{FRONTEND_DIR}}/**`
...
- **May edit:** `{{FRONTEND_DIR}}/**`
- **Do not edit:** `{{BACKEND_DIR}}/**`
