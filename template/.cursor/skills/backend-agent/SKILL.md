...
description: >-
  ...
  Own {{BACKEND_DIR}}/. Read backend ROLE and STATE. Hand off API contracts to
  Frontend via HANDOFF-TEMPLATE.
---

# Backend agent

Act as the **Backend** agent. Own `{{BACKEND_DIR}}/`.
...
Do not edit `{{FRONTEND_DIR}}/` unless handoff explicitly requires it.
